...
type HeaderFlag struct {
	QR     bool  // QR indicates wheater the message is a query 0 ir a response 1
	Opcode uint8 // Opcode specifies the kind of query in the message
	AA     bool  // AA is wheater the responding name server is a authority for the domain name
	TC     bool  // TC indicates wheater the message was truncated
	RD     bool  // RD indicates wheather recursion is desired
	RA     bool  // RA indicates wheater the recursion is avaliable in the name server
...
// GenerateFlag it returns the 16bit flag value from the individual flag
...
// HeaderFlagFromBytes() creates HeaderFlag instance from byte representation
...
// HasError() return if HeaderFlag has a error
// Checks the value of RCode
